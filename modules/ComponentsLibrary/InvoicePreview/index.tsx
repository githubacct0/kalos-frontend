...
export const InvoicePreview: FC<props> = ({ loggedUserId }) => {
  ...
  return ( 
    <> 
      ...
      <ul>
        <li>Frontend unit tests were created for this module automatically in <code>/test/modules/ComponentsLibrary/InvoicePreview</code></li>
