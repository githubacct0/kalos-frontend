...
export function attachProtobuf(
  clientPrototype: any,
  messagenger: any,
  asProperty: string,
): any {
  return function(target: any): any {
    ...
    const message =
      messagenger instanceof Function ? new messagenger() : messagenger;
    const expecting: string[] = defineThenApply(
      target,
      `${asProperty}$expect`,
      [],
    );
    const supplying: string[] = defineThenApply(
      target,
      `${asProperty}$supply`,
      [],
    );
    Object.defineProperty(target, `${asProperty}`, {
      value: client,
      configurable: false,
      writable: false,
      enumerable: false,
    });
    Object.defineProperty(target, `${asProperty}$message`, {
      value: message,
      configurable: false,
      writable: true,
      enumerable: false,
    });
    Object.defineProperty(target.prototype, `${asProperty}$Get`, {
      value: function() {
    ...
    Object.defineProperty(target.prototype, `${asProperty}$Send`, {
      value: function() {
        const setter = translateBetweenPBandObj.toSet;
        for (const supplied of supplying) {
          if (Reflect.has(this, supplied) && this[supplied] !== undefined) {
        ...
        console.log(message);
        if (client)
          client.Update(message).then((got: any) => {
            console.log(got);
          });
      },
      configurable: false,
    ...
    Object.defineProperty(target.prototype, `${asProperty}$After`, {
