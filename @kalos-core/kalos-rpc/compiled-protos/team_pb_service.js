...
TeamService.Create = {
  ...
  requestType: team_pb.Team,
  responseType: team_pb.Team
};
...
TeamService.BatchGet = {
  methodName: "BatchGet",
  service: TeamService,
  requestStream: false,
  responseStream: false,
  requestType: team_pb.Team,
  responseType: team_pb.TeamList
};
...
TeamServiceClient.prototype.get = function get(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(TeamService.Get, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
TeamServiceClient.prototype.batchGet = function batchGet(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(TeamService.BatchGet, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
