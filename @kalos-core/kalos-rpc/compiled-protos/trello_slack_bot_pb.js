...
proto.Request.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    details: (f = msg.getDetails()) && google_api_httpbody_pb.HttpBody.toObject(includeInstance, f),
    token: jspb.Message.getFieldWithDefault(msg, 3, ""),
    teamId: jspb.Message.getFieldWithDefault(msg, 4, ""),
    teamDomain: jspb.Message.getFieldWithDefault(msg, 5, ""),
    enterpriseId: jspb.Message.getFieldWithDefault(msg, 6, ""),
    channelId: jspb.Message.getFieldWithDefault(msg, 7, ""),
    channelName: jspb.Message.getFieldWithDefault(msg, 8, ""),
    userId: jspb.Message.getFieldWithDefault(msg, 9, ""),
    userName: jspb.Message.getFieldWithDefault(msg, 10, ""),
    command: jspb.Message.getFieldWithDefault(msg, 11, ""),
    text: jspb.Message.getFieldWithDefault(msg, 12, ""),
    responseUrl: jspb.Message.getFieldWithDefault(msg, 13, ""),
    triggerId: jspb.Message.getFieldWithDefault(msg, 14, ""),
    apiAppId: jspb.Message.getFieldWithDefault(msg, 15, "")
  };
...
/**
 * optional google.api.HttpBody details = 2;
 * @return {?proto.google.api.HttpBody}
 */
proto.Request.prototype.getDetails = function() {
 ...
 * @return {!proto.Request} returns this
*/
proto.Request.prototype.setDetails = function(value) {
 ...
 * @return {!proto.Request} returns this
 */
proto.Request.prototype.clearDetails = function() {
 ...
 * @return {boolean}
 */
proto.Request.prototype.hasDetails = function() {
...
/**
 * optional string enterprise_id = 6;
 * @return {string}
 */
...
/**
 * optional string response_url = 13;
 * @return {string}
 */
