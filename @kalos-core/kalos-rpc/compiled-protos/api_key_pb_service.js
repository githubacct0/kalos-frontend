...
var api_key_pb = require("./api_key_pb");
var grpc = require("@improbable-eng/grpc-web").grpc;

var ApiKeyService = (function () {
  function ApiKeyService() {}
  ApiKeyService.serviceName = "ApiKeyService";
...
ApiKeyService.BatchGet = {
  methodName: "BatchGet",
  service: ApiKeyService,
  requestStream: false,
  responseStream: false,
  requestType: api_key_pb.ApiKey,
  responseType: api_key_pb.ApiKeyList
};
...
ApiKeyServiceClient.prototype.get = function get(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(ApiKeyService.Get, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
ApiKeyServiceClient.prototype.batchGet = function batchGet(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(ApiKeyService.BatchGet, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
ApiKeyServiceClient.prototype.list = function list(requestMessage, metadata) {
  var listeners = {
    data: [],
    end: [],
    status: []
  };
  var client = grpc.invoke(ApiKeyService.List, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
